      ...
      <div className='flex flex-wrap justify-between mt-6 '>
        <div className='text-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-8 flex flex-col items-center justify-center'>
          <div className='mx-auto'>
            ...
            <Image src='/crown.png' width={200} height={40} alt='crown image'/>
          </div>
          <div className='text-3xl font-bold mt-4 leading-normal'>Modern Technology</div>
          <div className='text-lg mt-2'>Lorem ipsum dolor sit amet consectetur. Non commodo mi elit ut</div>
        </div>

        <div className='text-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-8 flex flex-col items-center justify-center'>
          <div className='mx-auto'>
            <Image src='/marketingEllipse.png' width={200} height={200}  className='absolute' alt='crown image'/>
            <Image src='/marketing.png' width={200} height={40} alt='text image'/>
          </div>
          <div className='text-3xl font-bold mt-4 leading-normal'>Speed And Accuracy</div>
          <div className='text-lg mt-2'>Lorem ipsum dolor sit amet consectetur. Non commodo mi elit ut</div>
        </div>
        ...
        <div className='text-center w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-8 flex flex-col items-center justify-center'>
          <div className='mx-auto'>
            ...
            <Image src='/team.png' width={200} height={40} alt='team image'/>
          </div>
          <div className='text-3xl font-bold mt-4 leading-normal'>Professional Team</div>
          <div className='text-lg mt-2'>Lorem ipsum dolor sit amet consectetur. Non commodo mi elit ut</div>
        </div>
      </div>
    </div>
