...
function AboutSection() {
  return (
    <div className='py-6 lg:py-16'>
      <div className='container mx-auto px-32 lg:px-2 xl:px-36 2xl:px-56 py-6 font-sans flex flex-col lg:flex-row'>
        <div className='mx-24 lg:mx-0 lg:w-1/2 lg:mr-5'>
          <div className='absolute mx-16 my-24 md:my-40 md:mx-32 z-10'>
            <Image src="/section2_img1.png" width={360} height={400} className='shadow-lg w-2/3 md:w-full bg-white border-8 border-white rounded-lg' alt='hero image'/>
          </div>
          <div>
        ...
        <div className='pt-48 lg:pt-0 lg:w-1/2 lg:pl-12'>
