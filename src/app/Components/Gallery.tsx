  ...
  return (
    <div>
      <div className='text-center my-12'>
        ...
        <div className='text-4xl mt-2 md:mx-12 xl:mx-8 leading-loose'>Our Many Services</div>
        <div className='mx-12 md:mx-44 lg:mx-72 xl:mx-96 xl:px-48 leading-relaxed'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised</div>
      </div>
      <div className='mx-56'>
      ...
      <div className='text-center my-5 pt-5'>
        <div className='text-xl mx-6 lg:mx-28 2xl:mx-96 xl:px-12'>Canvas Printing l Duratrance Printing l One Way Vision Printing l Blockout Banner Printing l Mesh Banner Printing l Photo Paper Printing l Flyers l Business Cards l Roll Up Stands l Promotional Stands & Many More Including Installation Services</div>
        <div className='my-5'>
